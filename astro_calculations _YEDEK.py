...
def calculate_astro_data(birth_date, birth_time, latitude, longitude, elevation_m=0, house_system=b"P", transit_info=None):
    ...
    try:
        ...
        # 2.1 Transit Pozisyonlar ve Evler
        transit_positions, transit_houses_data = get_transit_positions(transit_dt, transit_lat, transit_lon)
        result["transit_positions"] = transit_positions
        result["transit_houses"] = transit_houses_data
        
        # Transit ev cusplarının string key'lere sahip olduğundan emin olalım
        ...
        # 3.1 Sekonder (İkincil) Progresyonlar
        ...
        # Progresif ev cusplarının string key'lere sahip olduğundan emin olalım
        ...
        # 5. EK HESAPLAMALAR
        #####################################################
        logger.info("5. EK HESAPLAMALAR BAŞLIYOR")

        # 5.1 Transit Civarı Tutulmalar
        ...
        logger.info("5. EK HESAPLAMALAR TAMAMLANDI")
