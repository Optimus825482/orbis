...
from astro_calculations import calculate_celestial_positions
...
def test_calculate_celestial_positions_basic():
    ...
    assert 280.0 <= positions["Sun"]["degree"] <= 281.0 # Sun was around 280 deg on 2000-01-01
...
def test_calculate_celestial_positions_retrograde():
    ...
    # Example: Mercury was retrograde around May 2024
